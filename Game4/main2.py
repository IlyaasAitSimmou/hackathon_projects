...
Fighter1 = Fighter(1, 200, 110, False, warrior_data, warrior_sheet, warrior_animation_steps, sword_fx, turn)
Fighter2 = Fighter(2, 700, 110, True, wizard_data, wizard_sheet, wizard_animation_steps, magic_fx, turn)
...
while run:
    ...
    if round_over == False:
        ...
        if pygame.time.get_ticks() - round_over_time > round_over_cooldown:
            round_over = False
            intro_count = 5
            Fighter1 = Fighter(1 ,200, 310, False, warrior_data, warrior_sheet, warrior_animation_steps, sword_fx, turn)
            Fighter2 = Fighter(2, 700, 310, True, wizard_data, wizard_sheet, wizard_animation_steps, magic_fx, turn)
